...
func (a *ANX) FetchTicker(p currency.Pair, assetType string) (ticker.Price, error) {
...
func (a *ANX) FetchOrderbook(p currency.Pair, assetType string) (orderbook.Base, error) {
