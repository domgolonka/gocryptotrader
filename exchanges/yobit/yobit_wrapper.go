...
func (y *Yobit) FetchTicker(p currency.Pair, assetType string) (ticker.Price, error) {
...
func (y *Yobit) FetchOrderbook(p currency.Pair, assetType string) (orderbook.Base, error) {
