...
func (i *ItBit) FetchTicker(p currency.Pair, assetType string) (ticker.Price, error) {
...
func (i *ItBit) FetchOrderbook(p currency.Pair, assetType string) (orderbook.Base, error) {
