...
func (l *LakeBTC) FetchTicker(p currency.Pair, assetType string) (ticker.Price, error) {
...
func (l *LakeBTC) FetchOrderbook(p currency.Pair, assetType string) (orderbook.Base, error) {
