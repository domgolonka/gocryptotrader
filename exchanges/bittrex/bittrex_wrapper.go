...
func (b *Bittrex) FetchTicker(p currency.Pair, assetType string) (ticker.Price, error) {
...
func (b *Bittrex) FetchOrderbook(p currency.Pair, assetType string) (orderbook.Base, error) {
