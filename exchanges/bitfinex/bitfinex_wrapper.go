...
func (b *Bitfinex) FetchTicker(p currency.Pair, assetType string) (ticker.Price, error) {
...
func (b *Bitfinex) FetchOrderbook(p currency.Pair, assetType string) (orderbook.Base, error) {
