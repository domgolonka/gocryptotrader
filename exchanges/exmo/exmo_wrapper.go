...
func (e *EXMO) FetchTicker(p currency.Pair, assetType string) (ticker.Price, error) {
...
func (e *EXMO) FetchOrderbook(p currency.Pair, assetType string) (orderbook.Base, error) {
