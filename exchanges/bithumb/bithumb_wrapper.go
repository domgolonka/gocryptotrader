...
func (b *Bithumb) FetchTicker(p currency.Pair, assetType string) (ticker.Price, error) {
...
func (b *Bithumb) FetchOrderbook(p currency.Pair, assetType string) (orderbook.Base, error) {
