...
func (b *BTSE) FetchTicker(p currency.Pair, assetType string) (ticker.Price, error) {
...
func (b *BTSE) FetchOrderbook(p currency.Pair, assetType string) (orderbook.Base, error) {
