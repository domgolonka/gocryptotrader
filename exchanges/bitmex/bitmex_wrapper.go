...
func (b *Bitmex) FetchTicker(p currency.Pair, assetType string) (ticker.Price, error) {
...
func (b *Bitmex) FetchOrderbook(p currency.Pair, assetType string) (orderbook.Base, error) {
