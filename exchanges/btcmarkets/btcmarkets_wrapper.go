...
func (b *BTCMarkets) FetchTicker(p currency.Pair, assetType string) (ticker.Price, error) {
...
func (b *BTCMarkets) FetchOrderbook(p currency.Pair, assetType string) (orderbook.Base, error) {
