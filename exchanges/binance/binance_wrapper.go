...
func (b *Binance) FetchTicker(p currency.Pair, assetType string) (ticker.Price, error) {
...
func (b *Binance) FetchOrderbook(p currency.Pair, assetType string) (orderbook.Base, error) {
