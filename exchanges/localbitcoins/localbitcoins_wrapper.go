...
func (l *LocalBitcoins) FetchTicker(p currency.Pair, assetType string) (ticker.Price, error) {
...
func (l *LocalBitcoins) FetchOrderbook(p currency.Pair, assetType string) (orderbook.Base, error) {
