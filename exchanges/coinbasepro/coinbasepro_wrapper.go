...
func (c *CoinbasePro) FetchTicker(p currency.Pair, assetType string) (ticker.Price, error) {
...
func (c *CoinbasePro) FetchOrderbook(p currency.Pair, assetType string) (orderbook.Base, error) {
