...
func (b *Bitstamp) FetchTicker(p currency.Pair, assetType string) (ticker.Price, error) {
...
func (b *Bitstamp) FetchOrderbook(p currency.Pair, assetType string) (orderbook.Base, error) {
